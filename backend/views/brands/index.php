...
/* @var $searchModel common\models\Brands */
    ...
    <div class="row">
        <div class="col-lg-12">
             <div class="repair-index">
                ...
                <?php if (isset($_GET['SearchBrands'])){?>
                    <a href="<?php echo Yii::$app->request->baseUrl;?>/brands/index" class="btn btn-default clearBtn">
                        <span>Limpar</span>
                    </a>
                    <div class="clear"></div>
                <?php } ?>
...
<script>
    $(document).ready(function(){
        $(".deleteBtn").click(function(){
            ...
            var urlDest = urlBase+'/brands/delajax';
