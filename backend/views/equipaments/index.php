...
/* @var $searchModel common\models\Equipaments */
    ...
    <div class="row">
        <div class="col-lg-12">
             <div class="repair-index">
                ...
                <?php if (isset($_GET['SearchEquipaments'])){?>
                    <a href="<?php echo Yii::$app->request->baseUrl;?>/equipaments/index" class="btn btn-default clearBtn">
                        <span>Limpar</span>
                    </a>
                    <div class="clear"></div>
                <?php } ?>
...
<script>
    $(document).ready(function(){
        $(".deleteBtn").click(function(){
            ...
            var urlDest = urlBase+'/equipaments/delajax';
